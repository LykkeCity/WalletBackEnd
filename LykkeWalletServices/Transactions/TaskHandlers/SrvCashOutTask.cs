            ...
            try
            {
                ...
                else
                {
                    ...
                    var tx = builder
                        ...
                        .SendAsset(walletCoins.AssetAddress, new AssetMoney(new AssetId(new BitcoinAssetId(walletCoins.AssetId, Network)), Convert.ToInt64((data.Amount * walletCoins.AssetMultiplicationFactor))))
